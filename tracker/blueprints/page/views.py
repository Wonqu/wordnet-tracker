...
from tracker.blueprints.page.model import find_created_items_today, find_user_activity_now, find_user_activity_month
...
def users_activity_now():
    ...
    if q != '':
        ...
        active = find_user_activity_now(strftime("%Y-%m-%d", gmtime()), '')
